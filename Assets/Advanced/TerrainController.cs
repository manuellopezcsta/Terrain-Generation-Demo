...
public class TerrainController : MonoBehaviour {
    ...
    void LoadValuesFromMenu()
    {
        radiusToRender = PlayerPrefs.GetInt("renderRadius", 5);
        seed = PlayerPrefs.GetInt("seed", 5);
        //terrainSize = new Vector3(0,0,0);
        terrainSize.x = PlayerPrefs.GetInt("terrainSize", 1);
        terrainSize.y = PlayerPrefs.GetInt("terrainHeight", 5);
        terrainSize.z = PlayerPrefs.GetInt("terrainSize", 1);
        minObjectsPerTile = PlayerPrefs.GetInt("minimunObjects", 1);
        maxObjectsPerTile = PlayerPrefs.GetInt("maximunObjects", 2);
